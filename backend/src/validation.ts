...
cache['7d288aca80eeeeb30a56fac45fcac0da'] = {
  ...
  page: T.Optional(T.Integer({ format: 'int32', default: 1 })),
...
const schema = {
  ...
  '/api/catalog/products': {
    GET: {
      args: T.Optional(
        T.Object({
          query: T.Optional(T.Object(cache['7d288aca80eeeeb30a56fac45fcac0da']))
        })
      ),
      data: T.Union([
